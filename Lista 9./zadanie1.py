...
'''Po sprawdzeniu w PEP8 checker, kod odrobinę się zmienił, było duzo "trailing whitespace", zostalo jeszcze trochę za długich wersów,
czasami brakowało spacji między operatorami, lub po przecinku'''
